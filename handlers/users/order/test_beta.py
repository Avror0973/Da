...
# Добавить ключ к словарю
#
# choice_dict2 = {}
# user_choice = 'Горячий шик'
#
# # Узнать имя ключа и вывести значение
# choice_dict = {'Горячий шик': [2, 480], 'Бешеный лосось': [1, 180]}
# keyses = dict.keys(choice_dict) #Вывод ключей словаря
# print(choice_dict['Горячий шик'])
# for i in keyses:
#     print(choice_dict[i])
#
...
while flag == True:
    ...
    if choice1 == 'cancel':
        ...
        choice.update({choice1: [quantity, check]})
print(choice)